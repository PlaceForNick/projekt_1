...
if __name__ == '__main__':
        test = Transformacje1(100, 200, 300)
        print(test.xyz2flh())
...
if __name__=='__main__':
    proba1 = Transformacje2('-52 34 28.9', 15, 130)
    proba2 = Transformacje2('-52 34 28.9', 40, 130)
    print(proba1.fl2PL2000())
    print(proba2.fl2PL2000())
    proba= Transformacje2(13, 11, 130)
